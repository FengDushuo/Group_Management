...
import CreateOrderlistModal from './CreateOrderlistModal'
    ...
    render() {
        ...
        return (
            <div style={{ padding: 24 }}>
                ...
                <CreateOrderlistModal visible={isShowCreateModal} toggleVisible={this.toggleShowCreateModal} onRegister={this.getUsers} />
            </div>
        );
    }
}
